  ...
  <?php if ($page['home_high1'] || $page['home_high2'] || $page['home_high3']): ?>
    <div id="home-highlights" class="clearfix">
     ...
     <div class="home-highlight-box">
		 <img src="<?php print base_path() . drupal_get_path('theme', 'business') . '/images/home_high1.jpg'; ?>">
		 <div>
     ...
     <div class="home-highlight-box">
		 <img src="<?php print base_path() . drupal_get_path('theme', 'business') . '/images/home_high2.jpg'; ?>">
		 <div>
     ...
     <div class="home-highlight-box remove-margin">
		 <img src="<?php print base_path() . drupal_get_path('theme', 'business') . '/images/home_high3.jpg'; ?>">
		 <div>
